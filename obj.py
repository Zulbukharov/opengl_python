...
def main():
	...
	normalCords = glGetAttribLocation(shader, "vertexNormal")
	glVertexAttribPointer(normalCords, 3, GL_FLOAT, GL_FALSE, obj.model.itemsize * 3, ctypes.c_void_p(normal_offset))
	glEnableVertexAttribArray(normalCords)
	...
	light_location = glGetUniformLocation(shader, "light")
	...
	while not glfw.window_should_close(window):
		...
		glUniformMatrix4fv(light_location, 1, GL_FALSE, rot_y)
